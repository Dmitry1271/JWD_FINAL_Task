 ...
 */
public class WashingMashinePropertyHandler implements PropertyHandler {
    @Override
    public Map<String, Object> selectNeedProperties(List allProperties) {
        ...
        needProperties.put(PropertyNameConstant.VELOCITY_EN, allProperties.get(VELOCITY_EN));
        ...
        needProperties.put(PropertyNameConstant.VELOCITY_RU, allProperties.get(VELOCITY_RU));
    ...
    public boolean isValidProperties(List allProperties) {
        ...
        numericProperties.add(allProperties.get(VELOCITY_EN));
