 ...
 */
public class GoProfilePage implements Command {
    private static final Logger logger = LogManager.getLogger(GoProfilePage.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher(PageConstant.PROFILE_PAGE).forward(request, response);
