...
<header>
    <nav class="navbar navbar-toggleable-md navbar-light bg-faded main-nav">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/FrontController?command=go_profile_page" style="color:#000;"><b>${requestScope.user.login}</b></a>
                </li>
    ...
    <form action="/FrontController" method="get">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-12 col-sm-12">
                ...
                <input class="property-input" type="text" name="number_available"
                       placeholder="${input_number_avaliable}">
